...
const OPENAI_USD_PER_1K: Record<string, { input: number; output: number }> = {
...
export function calcCodexCredits(tokens: { input: number; output: number }, model?: string): number {
