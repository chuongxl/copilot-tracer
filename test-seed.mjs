...
const traces = [
  {
    ...
    ai_credits: 0.0234, duration_ms: 8400, skill_count: 2, agent_count: 0, mcp_count: 3, status: 'done',
  ...
  },
  {
    ...
    ai_credits: 0.0071, duration_ms: 3200, skill_count: 0, agent_count: 0, mcp_count: 2, status: 'done',
    tool_calls: JSON.stringify([
  ...
  },
  {
    ...
    ai_credits: 0.0398, duration_ms: 14200, skill_count: 1, agent_count: 2, mcp_count: 4, status: 'done',
    tool_calls: JSON.stringify([
  ...
  },
  {
    ...
    ai_credits: 0.0093, duration_ms: 5100, skill_count: 1, agent_count: 1, mcp_count: 2, status: 'running',
    tool_calls: JSON.stringify([
